...
{
     public class ArraySortingIntefaceToDelegate
     {
          #region User interface methods
          public static void BubbleSortOfSumRows(ref int[][] arr)
          {
               IComparer<int[]> param = new CompareBySum();
               BubbleSort(ref arr, param);
          }

          public static void BubbleSortOfMaxElem(ref int[][] arr)
          {
               IComparer<int[]> param = new CompareByMax();
               BubbleSort(ref arr, param);
          }

          public static void BubbleSortOfMinElem(ref int[][] arr)
          {
               IComparer<int[]> param = new CompareByMin();
               BubbleSort(ref arr, param);
          }
          #endregion

          /// <summary>
          /// Sort jagged array using delegate.
          /// </summary>
          /// <param name="arr">
          /// Input jagged array.
          /// </param>
          ...
          /// <summary>
          /// Method for sorting. Call method with delegate parameter.
          /// </summary>
          /// <param name="arr">
          /// Input jagged array.
          /// </param>
          ...
          private static void BubbleSort(ref int[][] arr, IComparer<int[]> param)
          {
               ...
               BubbleSort(ref arr, new InterfaceToDelegate(param).Delegate);
          }
          ...
          #region Classes for comparison
          private class CompareBySum : IComparer<int[]>
          {
          ...
          private class CompareByMax : IComparer<int[]>
          {
               public int Compare(int[] arr1, int[] arr2)
               {
          ...
          private class CompareByMin : IComparer<int[]>
          {
               public int Compare(int[] arr1, int[] arr2)
               {
