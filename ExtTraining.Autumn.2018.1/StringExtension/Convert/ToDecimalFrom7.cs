...
{
     class ToDecimalFrom7 : IConvertNumber
     {
          public int ConvertToDecimal(string str)
          {
               checked
               {
                    ...
                    {
                         if (array[i] == '1') result += (int)Math.Pow(7, i);
                         if (array[i] == '2') result += 2 * (int)Math.Pow(7, i);
                         if (array[i] == '3') result += 3 * (int)Math.Pow(7, i);
                         if (array[i] == '4') result += 4 * (int)Math.Pow(7, i);
                         if (array[i] == '5') result += 5 * (int)Math.Pow(7, i);
                         if (array[i] == '6') result += 6 * (int)Math.Pow(7, i);
                    }
                    return result;
               }
          }
