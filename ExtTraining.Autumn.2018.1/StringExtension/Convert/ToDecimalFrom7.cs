...
namespace StringExtension
{
     ...
     /// </summary>
     public class ToDecimalFrom7 : IConvertNumber
     {
          /// <summary>
          ...
          public int ConvertToDecimal(string str)
          {
               checked
               {
                    ...
                    for (int i = 0; i < array.Length; i++)
                    {
                         ...
                         if (array[i] == '2')
                         {
                              result += 2 * (int)Math.Pow(7, i);
                         }

                         if (array[i] == '3')
                         {
                              result += 3 * (int)Math.Pow(7, i);
                         }

                         if (array[i] == '4')
                         {
                              result += 4 * (int)Math.Pow(7, i);
                         }

                         if (array[i] == '5')
                         {
                              result += 5 * (int)Math.Pow(7, i);
                         }

                         if (array[i] == '6')
                         {
                              result += 6 * (int)Math.Pow(7, i);
                         }
                    }
