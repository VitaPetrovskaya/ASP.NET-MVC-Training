...
namespace StringExtension
{
     ...
     /// </summary>
     public class ToDecimalFrom14 : IConvertNumber
     {
          /// <summary>
          ...
          public int ConvertToDecimal(string str)
          {
               checked
               {
                    ...
                    for (int i = 0; i < array.Length; i++)
                    {
                         if (array[i] == '1')
                         {
                              result += (int)Math.Pow(14, i);
                         }

                         if (array[i] == '2')
                         {
                              result += 2 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == '3')
                         {
                              result += 3 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == '4')
                         {
                              result += 4 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == '5')
                         {
                              result += 5 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == '6')
                         {
                              result += 6 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == '7')
                         {
                              result += 7 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == '8')
                         {
                              result += 8 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == '9')
                         {
                              result += 9 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == 'A')
                         {
                              result += 10 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == 'B')
                         {
                              result += 11 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == 'C')
                         {
                              result += 12 * (int)Math.Pow(14, i);
                         }

                         if (array[i] == 'D')
                         {
                              result += 13 * (int)Math.Pow(14, i);
                         }
                    }
